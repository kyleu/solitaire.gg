...
object GameRulesSet {
  ...
  val completed = Seq("bakersdozen", "canfield", "congress", "fourteenout", "freecell", "golf", "gypsy", "klondike", "klondike1card", "missmilligan", "nestor", "pyramid", "spider", "trustytwelve", "yukon")
