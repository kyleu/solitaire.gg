...
object PolitaireTableauParser {
  val titles = Seq(
    "T0n" -> "Tableau piles", "T0Nm" -> "Tableau name", "T0d" -> "Tableau initial cards", "T0df" -> "Tableau cards face down",
    ...
    "T0fx" -> "Tableau action after deal", "T0dc" -> "Tableau with low cards at bottom",

    "T1n" -> "Tableau B piles", "T1Nm" -> "Tableau B name", "T1d" -> "Tableau B initial cards", "T1df" -> "Tableau B cards face down",
    ...
    "T1fx" -> "Tableau B action after deal", "T1dc" -> "Tableau B with low cards at bottom",

    "T2n" -> "Tableau C piles", "T2Nm" -> "Tableau C name", "T2d" -> "Tableau C initial cards", "T2df" -> "Tableau C cards face down",
    ...
    "T2fx" -> "Tableau C action after deal", "T2dc" -> "Tableau C with low cards at bottom",

    "T3n" -> "Tableau D piles", "T3Nm" -> "Tableau D name", "T3d" -> "Tableau D initial cards", "T3df" -> "Tableau D cards face down",
    ...
    "T3fx" -> "Tableau D action after deal", "T3dc" -> "Tableau D with low cards at bottom"
  )
