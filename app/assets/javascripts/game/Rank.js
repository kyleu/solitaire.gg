define(function () {
  ...
  Rank.nine = {
    ...
    locs: [[0.2, 0.2], [0.2, 0.4], [0.2, 0.6], [0.5, 0.3], [0.5, 0.5], [0.5, 0.7], [0.8, 0.4], [0.8, 0.6], [0.8, 0.8]]
  };
  Rank.ten = {
  ...
  Rank.jack = {
    value: 11, char: "J", name: "Jack"
  };
  Rank.queen = {
    value: 12, char: "Q", name: "Queen"
  };
  Rank.king = {
    value: 13, char: "K", name: "King"
  };
  Rank.ace = {
    value: 14, char: "A", name: "Ace"
  };
  Rank.unknown = {
    value: 0, char: "?", name: "Unknown"
  };
