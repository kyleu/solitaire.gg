define(['utils/Config', 'game/Card', 'game/pile/Pile', 'game/Playmat'], function (cfg, Card, Pile, Playmat) {
  ...
  Sandbox.prototype.preload = function() {
    ...
    this.game.load.image("card-back", "/assets/images/game/cards/standard/medium/BACK.png");
    this.game.load.image("empty-pile", "/assets/images/game/cards/standard/medium/EMPTY.png");
    this.game.load.spritesheet('card', '/assets/images/game/cards/standard/medium/ALL.png', this.game.cardSet.cardWidth, this.game.cardSet.cardHeight);
  };
  ...
  Sandbox.prototype.create = function() {
    ...
    this.game.ws.send("JoinGame", { "game": "sandbox" });
  };
