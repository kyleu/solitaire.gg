...
(function(window, document, undefined) {
  ...
  function setColor(ctx, hsv, rgb, hex) {
    ...
    var sliderHeight = 200; // ctx.slideElement.offsetHeight

    var mouseSlide = {
      y: (ctx.h * sliderHeight) / 360,
      x: 0    // not important
    };

    var pickerHeight = 200; //ctx.pickerElement.offsetHeight;
    var pickerWidth = 200; //ctx.pickerElement.offsetWidth;
