...
object PolitaireOverrides {
  val overrides = Map(
    "accordion" -> Map("W0cardsShown" -> 52),
    "bakersdozen" -> Map("Sn" -> 0, "Tn" -> 2, "T0n" -> 7, "T1n" -> 6, "T1s" -> 5, "T1f" -> 5, "T1dd" -> 1),
    "bisley" -> Map("Sn" -> 0, "W0n" -> 0, "Tn" -> 2, "T0n" -> 4, "T0d" -> 3, "T1n" -> 9, "T1d" -> 4, "T1r" -> 160, "T1f" -> 5),
    "deucesandqueens" -> Map("F0u" -> 0),
    "flowergarden" -> Map("W0cardsShown" -> 20),
